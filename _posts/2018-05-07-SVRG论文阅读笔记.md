...
最佳拜读了下大名鼎鼎的 SVRG 算法 [[5]](#Reference)，读完后把前前后后涉及到的方法都看了一遍，这里做个简单的综述和阅读理解，并描述了如何将方差缩减方法改造成一种在线算法。
...
因为 SAG 算法需要保存所有样本的梯度值，在实际的大规模工业应用中并不实用，因此就有来 SVRG 算法。

**SVRG 算法的迭代过程** (图片来自文章 [[4]](#Reference))

![svrg算法](/css/pics/2018-05-07-SVRG-SVRG.png)
...
![saga算法](/css/pics/2018-05-07-SVRG-SAGA.png)
